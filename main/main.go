...
var outputFile = flag.String("cmd_o", "output/out.pdf", "Output file. Required (and only used) in command line mode.")
...
func main() {
	...
	RegisterHandlers(
		router,
		ServeReportHandler{gfClient.NewV5Client, genReports.New},
	)
