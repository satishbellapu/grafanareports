...
func (m *mockGrafanaClient) GetDashboard(dashName string) (gfClient.Dashboard, error) {
	return gfClient.NewDashboard([]byte(dashJSON), m.variables), nil
}

func (m *mockGrafanaClient) GetPanelPng(p gfClient.Panel, dashName string, t gfClient.TimeRange) (io.ReadCloser, error) {
	m.getPanelCallCount++
...
func TestReport(t *testing.T) {
	Convey("When generating a report", t, func() {
		...
		rep := new(gClient, "testDash", gfClient.TimeRange{"1453206447000", "1453213647000"}, "", false)
		defer rep.Clean()
...
func (e *errClient) GetDashboard(dashName string) (gfClient.Dashboard, error) {
	return gfClient.NewDashboard([]byte(dashJSON), e.variables), nil
}

//Produce an error on the 2nd panel fetched
func (e *errClient) GetPanelPng(p gfClient.Panel, dashName string, t gfClient.TimeRange) (io.ReadCloser, error) {
	e.getPanelCallCount++
